INSERT INTO `regiones` (`id_region`,`nombre_region`,`abreviatura`,`capital`)
VALUES
...
INSERT INTO `provincias` (`id_provincia`,`nombre_provincia`,`id_region`)
VALUES
	(1,'Arica',1),
	(2,'Parinacota',1),
	(3,'Iquique',2),
...
INSERT INTO `comunas` (`id_comuna`,`nombre_comuna`,`id_provincia`)
VALUES
	(1,'Arica',1),
	(2,'Camarones',1),
	(3,'General Lagos',2),
